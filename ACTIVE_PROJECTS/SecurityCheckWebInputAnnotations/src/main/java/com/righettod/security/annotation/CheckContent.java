 ...
 * <li>Character list against character white list</li>
 * </ul>
...
public @interface CheckContent {
	...
	/**
	 * Json expression to define map representing collection of character for which the continuous repetition is limited to specified count.<br/>
