 ...
 * Build a cache (overstep objects count to a count between
 * "maxElementsInMemory" value and "maxElementsOnDisk" value in order to use
 * also disk storage) and display cache evolution until cache will be empty...
 * 
